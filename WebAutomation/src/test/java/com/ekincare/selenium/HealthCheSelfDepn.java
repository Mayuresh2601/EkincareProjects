...
public class HealthCheSelfDepn extends Base {
	...
	@Test
	public void healthselfdepn() throws InterruptedException {
...
//		driver.findElement(By.xpath("//footer/button[contains(@class,'sc-Ax')]")).click();
		...
		driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/div[1]/div/div[1]/div/div[1]/div[3]/div/div[3]/div/div/button[2]")).click();
		...
		driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/div[1]/div/div[1]/div[2]/div/div[1]/div/div[2]/button")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/div[1]/div/div[1]/div/div[1]/div[2]/div[1]/div/div/div[3]/label/span/div/p[2]")).click();
		driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/div[1]/div/div[1]/div/div[1]/div[2]/div[2]/div/div[2]/label/span/p")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/div[1]/div/div[1]/div/div[2]/div/div/div[2]/div/input")).sendKeys("1234567789");
		Thread.sleep(2000);
