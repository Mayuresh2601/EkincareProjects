...
public class HealthSelfTwoDepn extends Base{
	...
	@Test
	public void healthselftwodepn() throws InterruptedException {
...
//		driver.findElement(By.xpath("//footer/button[contains(@class,'sc-Ax')]")).click();
		...
		driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/div[1]/div/div[1]/div/div[1]/div[2]/div[2]/div/div[4]/label/span/p")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/div[1]/div/div[1]/div/div[2]/div/div/div[2]/div/input")).sendKeys("9876543210");
		Thread.sleep(2000);
